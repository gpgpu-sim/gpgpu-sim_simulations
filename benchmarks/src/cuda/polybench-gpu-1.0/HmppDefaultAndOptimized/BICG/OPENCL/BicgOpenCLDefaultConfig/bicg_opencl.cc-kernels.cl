...
__kernel __attribute__((reqd_work_group_size(256, 1, 1))) void hmpp_codelet__runBicg_loop1_(  __private int i_21, __global float* a, __global float* r, __global float* s)
{
  int j_1;
  ...
  {
  ;
  s[j_1] = (s[j_1]) + ((r[i_21]) * (a[(i_21 * (int) 4096) + j_1]));
  }
} 
