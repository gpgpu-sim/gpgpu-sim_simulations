...
__kernel __attribute__((reqd_work_group_size(32, 4, 1))) void hmpp_codelet__ataxLoopa_loop0_(  __global float* y)
{
  int i_5;
  int outer_i_2;
  i_5 = (get_global_id(0));
  outer_i_2 = (get_global_id(1));
  bool __hmppcg_guard = (!((i_5 <= (int) 1) & (outer_i_2 <= (int) 2047)));
  if(!__hmppcg_guard) 
  {
  ;
  y[i_5 + ((int) (outer_i_2 * (int) 2))] = (int) 0;
  }
} 

// kernel : hmpp_codelet__ataxLoopa_loop1_
__kernel __attribute__((reqd_work_group_size(32, 4, 1))) void hmpp_codelet__ataxLoopa_loop1_(  __global float* a, __global float* tmp, __global float* x)
{
  int i_6;
  int outer_i_4;
  i_6 = (get_global_id(0));
  outer_i_4 = (get_global_id(1));
  bool __hmppcg_guard = (!((i_6 <= (int) 1) & (outer_i_4 <= (int) 2047)));
  if(!__hmppcg_guard) 
  {
  ;
  tmp[i_6 + ((int) (outer_i_4 * (int) 2))] = (int) 0;
  {
    int __hmppcg_end, j_2;
    for (j_2 = (int) 0, __hmppcg_end = (int) 4095; j_2 <= __hmppcg_end; j_2 += (int) 1)
    {
      tmp[i_6 + ((int) (outer_i_4 * (int) 2))] = (tmp[i_6 + ((int) (outer_i_4 * (int) 2))]) + ((a[((i_6 + ((int) (outer_i_4 * (int) 2))) * (int) 4096) + j_2]) * (x[j_2]));
    } 
  }
  }
} 
...
__kernel __attribute__((reqd_work_group_size(256, 1, 1))) void hmpp_codelet__ataxLoopb_loop0_(  __global float* a_11, __global float* tmp_11, __global float* y_11)
{
  int j_3;
  ...
  ;
  {
    ...
    for (i_4 = (int) 0, __hmppcg_end = (int) 4095; i_4 <= __hmppcg_end; i_4 += (int) 1)
    {
      y_11[j_3] = (y_11[j_3]) + ((a_11[(i_4 * (int) 4096) + j_3]) * (tmp_11[i_4]));
    } 
  }
  }
} 
