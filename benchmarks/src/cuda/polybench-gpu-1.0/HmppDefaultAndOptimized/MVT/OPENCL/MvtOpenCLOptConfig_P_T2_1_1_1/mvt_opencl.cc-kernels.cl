...
__kernel __attribute__((reqd_work_group_size(32, 4, 1))) void hmpp_codelet__runMvt_loop0_(  __global float* a, __global float* x1, __global float* y1)
{
  int i_3;
  int outer_i_2;
  i_3 = (get_global_id(0));
  outer_i_2 = (get_global_id(1));
  bool __hmppcg_guard = (!((i_3 <= (int) 1) & (outer_i_2 <= (int) 2047)));
  if(!__hmppcg_guard) 
  {
  ;
  {
    ...
    {
      x1[i_3 + ((int) (outer_i_2 * (int) 2))] = (x1[i_3 + ((int) (outer_i_2 * (int) 2))]) + ((a[((i_3 + ((int) (outer_i_2 * (int) 2))) * (int) 4096) + j_1]) * (y1[j_1]));
    } 
  }
  }
} 
