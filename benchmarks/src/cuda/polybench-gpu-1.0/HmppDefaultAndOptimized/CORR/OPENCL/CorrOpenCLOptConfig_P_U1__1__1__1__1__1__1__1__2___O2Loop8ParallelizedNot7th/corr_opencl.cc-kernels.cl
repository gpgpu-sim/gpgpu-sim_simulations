...
__kernel __attribute__((reqd_work_group_size(128, 1, 1))) void hmpp_codelet__runCorr_loop3_(  __private int j1_11, __global float* psymmat)
{
  int i_5;
  ...
  {
  ;
  psymmat[((j1_11 + (int) 1) * (int) 2049) + (j1_11 + (int) 1)] = (double) 1.000000000000000E+00;
  }
} 

// kernel : hmpp_codelet__runCorr_loop4_
__kernel __attribute__((reqd_work_group_size(256, 1, 1))) void hmpp_codelet__runCorr_loop4_(  __private int j1_12, __global float* pdata, __global float* psymmat)
{
  int j2_1;
  j2_1 = (get_global_id(1) * get_global_size(0) + get_global_id(0));
  bool __hmppcg_guard = (!(j2_1 <= ((int) 2046 - j1_12)));
  if(!__hmppcg_guard) 
  {
  ;
  psymmat[((j1_12 + (int) 1) * (int) 2049) + (j2_1 + ((int) (j1_12 + (int) 2)))] = (double) 0.000000000000000E+00;
  {
    int __hmppcg_end, i_4;
    for (i_4 = (int) 0, __hmppcg_end = (int) 1023; i_4 <= __hmppcg_end; i_4 += (int) 1)
    {
      psymmat[((j1_12 + (int) 1) * (int) 2049) + (j2_1 + ((int) (j1_12 + (int) 2)))] = (psymmat[((j1_12 + (int) 1) * (int) 2049) + (j2_1 + ((int) (j1_12 + (int) 2)))]) + ((pdata[((((int) 2 * i_4) + (int) 1) * (int) 2049) + (j1_12 + (int) 1)]) * (pdata[((((int) 2 * i_4) + (int) 1) * (int) 2049) + (j2_1 + ((int) (j1_12 + (int) 2)))]));
      psymmat[((j1_12 + (int) 1) * (int) 2049) + (j2_1 + ((int) (j1_12 + (int) 2)))] = (psymmat[((j1_12 + (int) 1) * (int) 2049) + (j2_1 + ((int) (j1_12 + (int) 2)))]) + ((pdata[((((int) 2 * i_4) + (int) 2) * (int) 2049) + (j1_12 + (int) 1)]) * (pdata[((((int) 2 * i_4) + (int) 2) * (int) 2049) + (j2_1 + ((int) (j1_12 + (int) 2)))]));
    } 
  }
  psymmat[((j2_1 + ((int) (j1_12 + (int) 2))) * (int) 2049) + (j1_12 + (int) 1)] = psymmat[((j1_12 + (int) 1) * (int) 2049) + (j2_1 + ((int) (j1_12 + (int) 2)))];
  }
} 

// kernel : hmpp_codelet__runCorr_loop5_
__kernel __attribute__((reqd_work_group_size(128, 1, 1))) void hmpp_codelet__runCorr_loop5_(  __global float* psymmat)
{
  int i_6;
  i_6 = (get_global_id(1) * get_global_size(0) + get_global_id(0));
  bool __hmppcg_guard = (!(i_6 <= (long) 0));
  if(!__hmppcg_guard) 
  {
  ;
