...
__kernel __attribute__((reqd_work_group_size(32, 8, 1))) void hmpp_codelet__runFdtd_loop1_(  __global float* ey, __global float* hz)
{
  ...
  j_2 = (get_global_id(0));
  i_1 = (get_global_id(1));
  bool __hmppcg_guard = (!((j_2 <= (int) 1023) & (i_1 <= (int) 2046)));
  if(!__hmppcg_guard) 
  {
  ;
  ...
  ey[((i_1 + (int) 1) * (int) 2048) + (j_2 + (int) 1024)] = (ey[((i_1 + (int) 1) * (int) 2048) + (j_2 + (int) 1024)]) - ((double) 5.000000000000000E-01 * ((hz[((i_1 + (int) 1) * (int) 2048) + (j_2 + (int) 1024)]) - (hz[(i_1 * (int) 2048) + (j_2 + (int) 1024)])));
  }
} 
...
__kernel __attribute__((reqd_work_group_size(32, 8, 1))) void hmpp_codelet__runFdtd_loop3_(  __global float* ex, __global float* ey, __global float* hz)
{
  ...
  j_4 = (get_global_id(0));
  i_3 = (get_global_id(1));
  bool __hmppcg_guard = (!((j_4 <= (int) 1023) & (i_3 <= (int) 2047)));
  if(!__hmppcg_guard) 
  {
  ;
  ...
  hz[(i_3 * (int) 2048) + (j_4 + (int) 1024)] = (hz[(i_3 * (int) 2048) + (j_4 + (int) 1024)]) - ((double) 7.000000000000000E-01 * ((((ex[(i_3 * (int) 2049) + (j_4 + (int) 1025)]) - (ex[(i_3 * (int) 2049) + (j_4 + (int) 1024)])) + (ey[((i_3 + (int) 1) * (int) 2048) + (j_4 + (int) 1024)])) - (ey[(i_3 * (int) 2048) + (j_4 + (int) 1024)])));
  }
} 
