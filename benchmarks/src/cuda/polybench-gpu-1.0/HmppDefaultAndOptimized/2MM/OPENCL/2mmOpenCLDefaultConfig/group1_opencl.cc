  ...
  int &hmppcg_status, HMPPCG::CLcontext& context)
{
  ...
  clSetKernelArg(context.kernels[0], 2, sizeof(cl_mem), (void*) &(c->mem_obj));
...
void hmpp_codelet__twoMMloopb(
  HMPPCG::DataObject* c_1,
  HMPPCG::DataObject* d,
  HMPPCG::DataObject* e,
  int &hmppcg_status, HMPPCG::CLcontext& context)
{
...
HMPP_API int hmpp_setOpenCLDevice(hmpp_handle_t * __h, cl_context ctx, cl_device_id dev)
{
  ...
  __h->context.kernels_names.push_back("hmpp_codelet__twoMMloopa_loop0_");
  __h->context.kernels_names.push_back("hmpp_codelet__twoMMloopb_loop0_");
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  ...
  switch(__id) { 
    case 1: // hmpp_codelet__twoMMloopa(__arg1,__arg2,__arg0)
      hmpp_codelet__twoMMloopa(  __h->__arg1, __h->__arg2, __h->__arg0, status, __h->context);
      return status;
    case 2: // hmpp_codelet__twoMMloopb(__arg0,__arg3,__arg4)
      hmpp_codelet__twoMMloopb(  __h->__arg0, __h->__arg3, __h->__arg4, status, __h->context);
      return status;
  }
  return -1;
}
