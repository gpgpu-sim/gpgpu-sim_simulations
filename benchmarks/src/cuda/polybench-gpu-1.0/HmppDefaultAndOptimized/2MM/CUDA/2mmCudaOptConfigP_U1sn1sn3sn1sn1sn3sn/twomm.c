...
static void twoMMloopa(DATA_TYPE a[NI][NK], DATA_TYPE b[NK][NJ], DATA_TYPE c[NI][NJ])
{
	int i, j, k;
...
static void twoMMloopb(DATA_TYPE c[NI][NJ], DATA_TYPE d[NJ][NL], DATA_TYPE e[NI][NL])
{
	int i, j, k;
