...
__kernel __attribute__((reqd_work_group_size(256, 1, 1))) void hmpp_codelet__covarLoopc_loop0_(  __private int j1_21, __global float* pdata_11, __global float* psymmat)
{
  int j2_2;
  j2_2 = (get_global_id(1) * get_global_size(0) + get_global_id(0));
  bool __hmppcg_guard = (!(j2_2 <= ((int) 2047 - j1_21)));
  if(!__hmppcg_guard) 
  {
  ;
  psymmat[((j1_21 + (int) 1) * (int) 2049) + (j2_2 + ((int) (j1_21 + (int) 1)))] = (double) 0.000000000000000E+00;
  {
    int __hmppcg_end, i_5;
    for (i_5 = (int) 0, __hmppcg_end = (int) 2047; i_5 <= __hmppcg_end; i_5 += (int) 1)
    {
      psymmat[((j1_21 + (int) 1) * (int) 2049) + (j2_2 + ((int) (j1_21 + (int) 1)))] = (psymmat[((j1_21 + (int) 1) * (int) 2049) + (j2_2 + ((int) (j1_21 + (int) 1)))]) + ((pdata_11[((i_5 + (int) 1) * (int) 2049) + (j1_21 + (int) 1)]) * (pdata_11[((i_5 + (int) 1) * (int) 2049) + (j2_2 + ((int) (j1_21 + (int) 1)))]));
    } 
  }
  psymmat[((j2_2 + ((int) (j1_21 + (int) 1))) * (int) 2049) + (j1_21 + (int) 1)] = psymmat[((j1_21 + (int) 1) * (int) 2049) + (j2_2 + ((int) (j1_21 + (int) 1)))];
  }
} 
