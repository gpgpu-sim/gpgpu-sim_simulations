...
{
  __h->context.prog_name = "gemm_opencl.cc-kernels.cl";
  __h->context.kernels_names.push_back("hmpp_codelet__runGemm_loop0_");
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  ...
  switch(__id) { 
    case 1: // hmpp_codelet__runGemm(__arg0,__arg1,__arg2)
      hmpp_codelet__runGemm(  __h->__arg0, __h->__arg1, __h->__arg2, status, __h->context);
      return status;
  }
  return -1;
}
