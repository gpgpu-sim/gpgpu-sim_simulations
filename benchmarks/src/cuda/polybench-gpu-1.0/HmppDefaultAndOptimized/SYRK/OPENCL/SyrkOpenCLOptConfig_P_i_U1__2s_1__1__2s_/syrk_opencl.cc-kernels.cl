...
// kernel : hmpp_codelet__runSyrk_loop0_
__kernel __attribute__((reqd_work_group_size(32, 8, 1))) void hmpp_codelet__runSyrk_loop0_(  __global float* c)
{
  float tmp_2;
  int j_1;
  int i_1;
  j_1 = (get_global_id(0));
  i_1 = (get_global_id(1));
  bool __hmppcg_guard = (!((j_1 <= (int) 511) & (i_1 <= (int) 1023)));
  if(!__hmppcg_guard) 
  {
  ;
  tmp_2 = (float) ((int) 4546);
  c[(i_1 * (int) 1024) + j_1] = (c[(i_1 * (int) 1024) + j_1]) * tmp_2;
  c[(i_1 * (int) 1024) + (j_1 + (int) 512)] = (c[(i_1 * (int) 1024) + (j_1 + (int) 512)]) * tmp_2;
  }
} 

// kernel : hmpp_codelet__runSyrk_loop1_
__kernel __attribute__((reqd_work_group_size(32, 8, 1))) void hmpp_codelet__runSyrk_loop1_(  __global float* a, __global float* c)
{
  int j_2;
  int i_2;
  j_2 = (get_global_id(0));
  i_2 = (get_global_id(1));
  bool __hmppcg_guard = (!((j_2 <= (int) 1023) & (i_2 <= (int) 1023)));
  if(!__hmppcg_guard) 
  {
  ;
  {
    ...
    {
      float tmp_1;
      tmp_1 = (float) ((int) 12435);
      c[(i_2 * (int) 1024) + j_2] = (c[(i_2 * (int) 1024) + j_2]) + ((tmp_1 * (a[(i_2 * (int) 1024) + k_1])) * (a[(j_2 * (int) 1024) + k_1]));
      c[(i_2 * (int) 1024) + j_2] = (c[(i_2 * (int) 1024) + j_2]) + ((tmp_1 * (a[(i_2 * (int) 1024) + (k_1 + (int) 512)])) * (a[(j_2 * (int) 1024) + (k_1 + (int) 512)]));
    } 
  }
  }
} 
