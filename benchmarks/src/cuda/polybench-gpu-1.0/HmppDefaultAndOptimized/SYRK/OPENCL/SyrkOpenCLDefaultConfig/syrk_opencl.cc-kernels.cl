...
__kernel __attribute__((reqd_work_group_size(32, 8, 1))) void hmpp_codelet__runSyrk_loop0_(  __global float* c)
{
  ...
  j_1 = (get_global_id(0));
  i_1 = (get_global_id(1));
  bool __hmppcg_guard = (!((j_1 <= (int) 1023) & (i_1 <= (int) 1023)));
  if(!__hmppcg_guard) 
  {
  ;
  c[(i_1 * (int) 1024) + j_1] = (c[(i_1 * (int) 1024) + j_1]) * ((float) ((int) 4546));
  }
} 
...
__kernel __attribute__((reqd_work_group_size(32, 8, 1))) void hmpp_codelet__runSyrk_loop1_(  __global float* a, __global float* c)
{
  ...
  ;
  {
    ...
    for (k_1 = (int) 0, __hmppcg_end = (int) 1023; k_1 <= __hmppcg_end; k_1 += (int) 1)
    {
      c[(i_2 * (int) 1024) + j_2] = (c[(i_2 * (int) 1024) + j_2]) + ((((float) ((int) 12435)) * (a[(i_2 * (int) 1024) + k_1])) * (a[(j_2 * (int) 1024) + k_1]));
    } 
  }
  }
} 
