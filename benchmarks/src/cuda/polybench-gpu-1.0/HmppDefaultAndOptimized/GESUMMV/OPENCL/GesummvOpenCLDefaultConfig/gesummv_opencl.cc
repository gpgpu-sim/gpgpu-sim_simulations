  ...
  int &hmppcg_status, HMPPCG::CLcontext& context)
{
  ...
  clSetKernelArg(context.kernels[0], 2, sizeof(cl_mem), (void*) &(tmp1->mem_obj));
  clSetKernelArg(context.kernels[0], 3, sizeof(cl_mem), (void*) &(x1->mem_obj));
  clSetKernelArg(context.kernels[0], 4, sizeof(cl_mem), (void*) &(y1->mem_obj));
...
{
  __h->context.prog_name = "gesummv_opencl.cc-kernels.cl";
  __h->context.kernels_names.push_back("hmpp_codelet__runGesummv_loop0_");
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  ...
  switch(__id) { 
    case 1: // hmpp_codelet__runGesummv(__arg0,__arg1,__arg2,__arg3,__arg4)
      hmpp_codelet__runGesummv(  __h->__arg0, __h->__arg1, __h->__arg2, __h->__arg3, __h->__arg4, status, __h->context);
      return status;
  }
  return -1;
}
