...
all:
	nvcc -O3 ${GENCODE_SM10} ${GENCODE_SM13} ${GENCODE_SM20} ${GENCODE_SM30} ${GENCODE_SM35} ${GENCODE_SM35} ${GENCODE_SM50} ${GENCODE_SM50} ${GENCODE_SM60} ${GENCODE_SM62} ${CUFILES} -o ${EXECUTABLE} 
clean:
	rm -f *~ *.exe
