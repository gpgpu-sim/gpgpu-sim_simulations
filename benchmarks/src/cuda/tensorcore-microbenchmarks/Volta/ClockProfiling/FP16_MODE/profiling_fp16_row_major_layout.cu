...
int main(int argc, char* argv[]) {
   ...
   printf("c_host\n");
   initialize_matrix<host_type>(c_host_wmma,MATRIX_M,MATRIX_N,C_LAYOUT,RANDOM);
   printf("d_cal_host\n");
   ...
   //printf("CHECKING\n"); 
   //Disabling checking since in FP16 mode with linear initialization of matrix will result in overflow.
   //Since we want to find the distribution therefore we didn't care about the final result.
